...
const tableVariants = cva(["w-full", "border-collapse", "text-left"], {
  ...
  compoundVariants: [
    ...
    { theme: "dark", variant: "vertical-lines", className: "" },
    ...
    { theme: "light", variant: "vertical-lines", className: "" },
    { theme: "light", variant: "dense", className: "" },
    { theme: "light", variant: "card", className: "" },
    { theme: "light", variant: "vertical", className: "" },
  ],
  defaultVariants: {
    variant: "default",
    theme: "dark",
