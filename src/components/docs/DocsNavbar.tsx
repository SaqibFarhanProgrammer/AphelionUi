      ...
      <div className="w-full pl-74 pr-10  mx-auto h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="font-['inter-semi'] text-[13px] text-white/90 hover:text-white/70 transition-colors duration-200"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="font-['inter-semi'] text-[12px] text-white/90">
              2.4k
            </span>
          </a>
